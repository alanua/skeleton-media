...
CONFIG_PATHS=(/etc/lightdm/lightdm.conf.d/50-skeleton-home-edge-autologin.conf /home/skeleton/.config/openbox/autostart /home/skeleton/.config/mpv/mpv.conf /etc/chromium/policies/managed/skeleton-home-edge-media.json)
...
restore_configs() {
  ...
  while IFS="$(printf '\t')" read -r path state mode uid gid backup; do
    case "$path" in
      /etc/lightdm/lightdm.conf.d/50-skeleton-home-edge-autologin.conf|/home/skeleton/.config/openbox/autostart|/home/skeleton/.config/mpv/mpv.conf|/etc/chromium/policies/managed/skeleton-home-edge-media.json) ;;
...
printf '%s' "$desired_openbox" | cmp -s - /home/skeleton/.config/openbox/autostart || needs_config=true
printf '%s' "$desired_mpv" | cmp -s - /home/skeleton/.config/mpv/mpv.conf || needs_config=true
...
if [ "$needs_config" = true ]; then
  ...
  install -d -m 0755 -o 1000 -g 1000 /home/skeleton/.config/openbox /home/skeleton/.config/mpv || fail_after_mutation config_prepare_failed
  ...
  printf '%s' "$desired_openbox" >/home/skeleton/.config/openbox/autostart || fail_after_mutation config_write_failed
  chown 1000:1000 /home/skeleton/.config/openbox/autostart || fail_after_mutation config_write_failed
  chmod 0755 /home/skeleton/.config/openbox/autostart || fail_after_mutation config_write_failed
  printf '%s' "$desired_mpv" >/home/skeleton/.config/mpv/mpv.conf || fail_after_mutation config_write_failed
  chown 1000:1000 /home/skeleton/.config/mpv/mpv.conf || fail_after_mutation config_write_failed
  chmod 0644 /home/skeleton/.config/mpv/mpv.conf || fail_after_mutation config_write_failed
